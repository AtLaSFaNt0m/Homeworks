...
async def get_buying_list(message: types.Message):
    ...
    for product in products:
        ...
        await message.answer_photo(InputFile('image.jpg'))  # Замените на соответствующее изображение

    inline_markup = InlineKeyboardMarkup()
    for product in products:
        inline_markup.add(InlineKeyboardButton(product[1], callback_data=f'product_buying_{product[0]}'))
